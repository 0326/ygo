...
const CN = {
  ...
  // 首页
  "home.heroTitle1": "卡图最美 · 查卡最爽", "home.heroTitle2": "最懂收藏党", "home.heroTitle3": "的游戏王卡库",
  "home.heroSub": "全网最完整的简中卡图与系列图鉴，加上让创作者上瘾的在线制卡器与分享长图工具。",
...
const JP: Record<UIKey, string> = {
  ...
  "home.heroTitle1": "美しいカード画像 · 快適な検索", "home.heroTitle2": "コレクター向け", "home.heroTitle3": "の遊戯王データベース",
  "home.heroSub": "充実したカード画像とテーマ図鑑、オリジナルカードメーカーとシェア画像ツール。",
...
const EN: Record<UIKey, string> = {
  ...
  "home.heroTitle1": "Beautiful artwork · Fast search", "home.heroTitle2": "A Yu-Gi-Oh! database", "home.heroTitle3": "built for collectors",
  "home.heroSub": "Complete card gallery and archetype index, plus an addictive online card maker and share-image tools.",
