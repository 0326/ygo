...
const CN = {
  ...
  "auth.toRegister": "没有账号？注册一个 →", "auth.toLogin": "已有账号？直接登录 →",
  "auth.title": "登录 / 注册", "auth.sub": "登录后可收藏卡片、卡包、壁纸，并把卡组存到账号里",
  "me.title": "用户中心", "me.favCards": "收藏卡片", "me.favSets": "收藏卡包",
  "me.favWallpapers": "收藏壁纸", "me.decks": "我的卡组",
  "me.empty": "这里还是空的", "me.open": "打开", "me.delete": "删除",
  "me.admin": "管理后台",
  "fav.add": "☆ 收藏", "fav.added": "★ 已收藏", "fav.loginFirst": "登录后可收藏",
...
const JP: Record<UIKey, string> = {
  ...
  "auth.toRegister": "アカウントがない？新規登録 →", "auth.toLogin": "アカウントをお持ちの方はこちら →",
  "auth.title": "ログイン / 新規登録", "auth.sub": "ログインするとカード・パック・壁紙のお気に入りとデッキ保存が使えます",
  "me.title": "マイページ", "me.favCards": "お気に入りカード", "me.favSets": "お気に入りパック",
  "me.favWallpapers": "お気に入り壁紙", "me.decks": "マイデッキ",
  "me.empty": "まだ何もありません", "me.open": "開く", "me.delete": "削除",
  "me.admin": "管理画面",
...
const EN: Record<UIKey, string> = {
  ...
  "auth.toRegister": "No account? Sign up →", "auth.toLogin": "Have an account? Log in →",
  "auth.title": "Log in / Sign up", "auth.sub": "Sign in to favorite cards, sets and wallpapers, and save decks to your account",
  "me.title": "My Page", "me.favCards": "Favorite cards", "me.favSets": "Favorite sets",
  "me.favWallpapers": "Favorite wallpapers", "me.decks": "My decks",
  "me.empty": "Nothing here yet", "me.open": "Open", "me.delete": "Delete",
  "me.admin": "Admin",
